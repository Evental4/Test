...
//каким путем владеет клара?,1,PAZ.bmp,разрушения,IZOB.bmp,изобилия,ЭPYD.bmp,эрудикция
//каким путем владеет гг путя раз.?,3,NEBOT.bmp,небытие,IZOB.bmp,изобилия,PAZ.bmp,разрушения
//каким путем владеет химека?,1,ЭPYD.bmp,эрудикция,NEBOT.bmp,небытие,IZOB.bmp,изобилия
//каким путем владеет фельт?,3,PAZ.bmp,разрушения,IZOB.bmp,изобилия,NEBOT.bmp,небытие
//каким путем владеет байлу?,1,IZOB.bmp,изобилия,NEBOT.bmp,небытие,PAZ.bmp,разрушения
//каким путем владеет серебряный волк?,1,NEBOT.bmp,небытие,ЭPYD.bmp,эрудикция,PAZ.bmp,разрушения
//каким путем владеет сервал?,3,NEBOT.bmp,небытие,IZOB.bmp,изобилия,ЭPYD.bmp,эрудикция
